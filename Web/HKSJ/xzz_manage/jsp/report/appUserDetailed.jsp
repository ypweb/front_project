...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/report/appUserDetailed.js"></script>
  ...
  <body>
  		<div class="main_r">
			<h3 class="right_nav">报表管理 > 审核用户明细</h3>

			<div class="table_bg">
				<ul class="inquire">
					<li>
						<label class="v">审核人名称：</label>
  		...
  		<div class="main_r">
			<h3 class="right_nav">报表 > 每天审核统计</h3>

			<div class="table_bg">
				<ul class="inquire">
					<li>
						<label class="v">审核人名称：</label>
						<input id="adminName" name="adminName" type="text" class="input v">
					</li>
					<li>
						<label class="v">时间：</label> 
						<input class="Wdate" type="text"  size="12" style="width:110px"  id="StartTime1" name="StartTime1" onFocus="var endtime1=$dp.$('endtime1');WdatePicker({onpicked:function(){endtime1.focus();},maxDate:'#F{$dp.$D(\'endtime1\')}'});"	></input>
			     		-
						<input class="Wdate" type="text"   size="12" style="width:110px" id="endtime1" name="endtime1"  onFocus="WdatePicker({minDate:'#F{$dp.$D(\'StartTime\')}'})"></input>
					</li>
					<li>
						<button class="btn_cx" type="button" onclick="queryS()">查询</button>
					</li>
					</div>
				</ul>
		</div>
