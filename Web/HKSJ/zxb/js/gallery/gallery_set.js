...
/*程序入口*/
require(['jquery','dialog','gallery_query','masonry','pagination','lazyload','rule','commonfn','validform','city_select','modal_dialog','cookie','common'],function($,undefined,GalleryQuery,Masonry,Pagination,undefined,Rule,CommonFn,undefined,City_Select,Modal_Dialog,undefined,Common) {
	$(function() {
			//页面元素获取
