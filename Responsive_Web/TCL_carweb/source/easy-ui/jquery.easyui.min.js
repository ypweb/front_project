...
(function($) {
	...
	function _79c(_79d) {
		...
		if (!opts.disabled && !opts.readonly) {
			_7a1.bind("mousedown.combo", function(e) {
				...
				e.stopPropagation();
			}).bind("keyup.combo", function(e) {//wench modify
				switch (e.keyCode) {
				case 38:
	...
	$.fn.combo.parseOptions = function(_7d8) {
		...
		return $.extend( {}, $.fn.validatebox.parseOptions(_7d8), $.parser
			...
			value : (t.val() || undefined),
			isAllowText : (t.attr("isAllowText") ? (t.attr("isAllowText") == "true" || t.attr("isAllowText") == true) : true)//wench
		});
	};
...
(function($) {
	...
	function _7e7(_7ee, _7ef, _7f0) {
		...
		for ( var i = 0; i < _7ef.length; i++) {
			...
			if(opts.isAllowText||s!==undefined){//wench
				vv.push(v);
				ss.push(s);
			}
//			vv.push(v);
