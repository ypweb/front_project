$(function(){
		...
		{	
			...
			$("#windowIf").attr("src","toAddUserVest.do");
			$("#windowDiv").window({title : '新增马甲账户',width:400,height:350}).window('open');
		}
	...
	//查询
	function query(){
		tb.load({start:0,ADVERT_NAME:$('#ADVERT_NAME').val(),bTime:$('#StartTime').val(),eTime:$('#endtime').val()});
