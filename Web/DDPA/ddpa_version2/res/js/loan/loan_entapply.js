(function($){
	$(function(){
		...
		/*页面元素*/
		var dealline_btn=$("#dealline_btn"),dealline_wrap=$("#dealline_wrap"),dealline_sel=$("#dealline_sel"),dealline_value=$("#dealline_value span"),dltextval=loandeadline.val(),bgwidth=dealline_wrap.width();
		/*初始化*/
