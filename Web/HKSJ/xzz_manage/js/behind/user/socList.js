$(function(){
		...
		cm:[
									 ...
									 {tag:'a', style:'cursor: pointer',child:{tag:'span',child:isDisabled},events:{click:function(){
										 ...
										 $.jsonToControl(
												 {tag:'a', style:'cursor: pointer',child:{tag:'span',child:"发表长文"},events:{click:function(){
													 window.location.href="/xzzBehind/longArticle/toAdd.do?userId="+r.id; 
													 return false;}}}
												 ),
										 $.jsonToControl(
												 {tag:'a', style:'cursor: pointer',child:{tag:'span',child:"长文管理"},events:{click:function(){
													 window.location.href="/xzzBehind/longArticle/userListAll.do?id="+r.id; 
													 return false;}}}
												 ) 
			...
			,
			url:'user/listAll.do?userType=1' ,   
			autoload:true,
			total:'totalCount',
			root:'items',
			footbar:{
	...
	function toAdd()
	{	 
		window.location.href="/xzzBehind/user/toAdd.do"; 
	}
