...
(function($) {
	...
	function _17(_21, _22, _23) {
		...
		for ( var i = 0; i < _22.length; i++) {
			var v = _22[i];
			//var s = v;
			var s = _24.isAllowText ? v : undefined;//wench modify
			var _27 = _1(_25, _24.valueField, v);
			if (_27) {
				s = _27[_24.textField];
			}
			
			if(_24.isAllowText||s!==undefined){//wench
				vv.push(v);
				ss.push(s);
			}
//			vv.push(v);
			...
			if (_4b) {
				...
				_4b = $.data(this, "combobox", {
					options : $.extend( {}, $.fn.combobox.defaults,
							$.fn.combobox.parseOptions(this), _48)
				});
				_43(this);
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
				...
				_4f.find("div.combobox-item-selected").removeClass(
						"combobox-item-selected");
			});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseData = function(_55) {
		...
		$(_55)
				...
				.each(
						function() {
							var _58 = {};
							_58[_57.valueField] = $(this).attr("value") != undefined ? $(
									this).attr("value")
									: $(this).html();
