...
(function($) {
	...
	function _2f(_30, _31) {
		...
		_33.validatebox($.extend( {}, _32,
				{
					deltaX : (_32.hasDownArrow ? _32.deltaX
							: (_32.deltaX > 0 ? 1 : -1))
				}));
		if (_31) {
	...
	$.fn.combo.parseOptions = function(_68) {
		...
		return $.extend( {}, $.fn.validatebox.parseOptions(_68), $.parser
			...
			isAllowText : (t.attr("isAllowText") ? (t.attr("isAllowText") == "true" || t.attr("isAllowText") == true) : true)//wench modify
		});
	};
