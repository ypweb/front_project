...
<link href="favicon.ico" rel="shortcut icon">
	...
	<script type="text/javascript" src="js/behind/category/typeone_update.js"></script>
</head>
		...
		<div style="margin-left:10px;">
			<table class="mainTable">
				...
				<tr>
					...
					<td colspan="2">
					<input id="typeoneName" name="typeoneName" maxlength="32" ><span style="color: red">*</span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="2">
						<textarea id="descc" name="descc" maxlength="32" style="resize: none;"></textarea>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="2">
						<input id="orderNum" maxlength="9"  name="orderNum" type="text" value="" oninput="this.value=this.value.replace(/\D/g,'')" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'')"/><span style="color: red">*</span>
					</td>
				</tr>
