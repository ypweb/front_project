...
/*程序入口*/
require(['jquery','bootstrap','common','dialog','querydata','highchart','tree'], function($,$strap,undefined,undefined,undefined,undefined,undefined) {
	$(function() {
		/*页面元素引用*/
		var $dealer_tab=$('#dealer_tab'),
				...
				/*load: function () {
												...
												ren.label('aaaa',0,0).attr(charts_item).css({color: 'white'}).add();
										}*/
		//ren.path(hArrow).attr(charts_line).add();
		//ren.label('aaaa',0,0).attr(charts_item).css({color: 'white'}).add();
