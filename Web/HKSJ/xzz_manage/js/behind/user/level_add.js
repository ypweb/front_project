...
function add()
{
	...
	if($("#LEVEL_ICON").val().replace(/[ ]/g,"")=="")
	{
		$.messager.alert("提示","图标不能为空","info",function(){document.getElementById("LEVEL_ICON").focus();});
		return;
	}
	...
	$.post('saveLevel.do',$("#insertorupdForm").serialize(),function(result){
		if(result==1) //修改成功
		{
