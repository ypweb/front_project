...
/*程序入口*/
require(['jquery','bootstrap','dialog','querydata','validform','common','submenu','themetitle','rule','commonfn'], function($,$strap,undefined,undefined,undefined,Common,undefined,undefined,Rule,undefined,CommonFn) {
	$(function() {
			//页面元素引用
			var $submenu=$('#submenu'),
			...
			var tiplist=[basetip,receivetip,banktip,logintip],
					nodelist=[[$referenceno,$dealername,$idcard],
