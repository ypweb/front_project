...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/advert/advertStop.js"></script>
  ...
  <body>
		...
		<div class="main_r">
			<h3 class="right_nav">广告管理 > 暂停广告管理</h3>
				...
				<ul class="inquire">
					<div class="clearfix">
						<li>
							...
							<input id="stopName" name="stopName" type="text" class="input v">
						</li>
						<li>
