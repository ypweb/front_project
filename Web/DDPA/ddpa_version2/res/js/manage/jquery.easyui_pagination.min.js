...
var _83=_82.options;
var bb=_82.bb={};
var _84=$(_81).addClass("pagination").html("<table id=\"tr_pgplugs\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");
var tr=_84.find("tr");
...
var mc_tempfrom=_95.total==0?0:_95.pageSize*(_95.pageNumber-1)+1;
var mc_tempto=Math.min(_95.pageSize*(_95.pageNumber),_95.total);
var mc_temptotal=_95.total;
var mc_tempall=_95.total%_95.pageSize==0?_95.total/_95.pageSize:(parseInt(_95.total-(_95.total%_95.pageSize))/_95.pageSize)+1;
var _99=_95.displayMsg;
_99=_99.replace(/{from}/,mc_tempfrom);
_99=_99.replace(/{to}/,mc_tempto);
_99=_99.replace(/{total}/,mc_temptotal);
_99=_99.replace(/{cpage}/,_95.pageNumber);
_99=_99.replace(/{apage}/,mc_tempall);
...
$.fn.pagination.defaults={total:1,pageSize:5,pageNumber:1,pageList:[5,10,15,20],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_a6,_a7){
},onBeforeRefresh:function(_a8,_a9){
},onRefresh:function(_aa,_ab){
},onChangePageSize:function(_ac){
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"共{total}条记录&nbsp;&nbsp;当前第&nbsp;<span style=\"color:#e54228;\">{cpage}</span>/{apage}&nbsp;页&nbsp;",nav:{first:{iconCls:"pagination-first",handler:function(){
