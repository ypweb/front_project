...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/appinterest/appinterest_update.js"></script>
  </head>
  ...
  <body>
  	<form id="appInterestForm" method="post" >
		...
		<input type="button" class="btn_an" value="保存" onclick="addValidateStatics()" id="baocunid">
