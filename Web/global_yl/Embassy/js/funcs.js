...
function showSwitchTitle(screen) {
	var titlestr = "" ;
	titlestr = '<h3><a href="../../../yanchu_wl/Embassy/js/'+Switcher[screen]['link']+'" target="_blank">'+Switcher[screen]['title']+'</a></h3><p><a href="../../../yanchu_wl/Embassy/js/'+Switcher[screen]['link']+'" target="_blank">'+Switcher[screen]['stitle']+'</a></p>' ;
