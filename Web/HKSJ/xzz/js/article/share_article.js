...
require(['jquery'],function($) {
	$(function() {
			...
			var $share_download=$('#share_download'),
					$share_good_download=$('#share_good_download'),
				...
				if(/(iPhone|iPod|ios|iOS|iPad|Backerry|WebOS|Symbian|Windows Phone|Phone|android|Android)/i.test(type)){
						...
						if(/(android|Android)/i.test(type)){
								...
								if($share_good_download){
									$share_good_download.attr('href','http://a.app.qq.com/o/simple.jsp?pkgname=com.huika.xiaozizhuan');
								}
						}else if(/(iPhone|iPod|ios|iOS|iPad)/i.test(type)){
								//ios
								$share_download.attr('href','#');
								if($share_good_download){
									$share_good_download.attr('href','#');
								}
					...
					if($share_good_download){
						$share_good_download.attr('href','http://xiaozizhuan.com/');
					}
				}
