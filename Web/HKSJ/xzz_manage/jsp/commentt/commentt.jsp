...
<script type="text/javascript" src="js/behind/commentt/commentt.js"></script>
<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
</head>

<body>
	<div class="main_r">
		<h3 class="right_nav">运营管理 > 评论管理</h3>
			...
			<ul class="inquire">
				<div class="clearfix">
						...
						<label class="v">评论内容：</label>
							<input id="COMMENTT_CONTENT" type="text" class="input v">
						</li>
						
						<li>
						<label class="v">视频名称：</label>
							<input id="VIDEO_NAME" type="text" class="input v">
						</li>
					<li>
