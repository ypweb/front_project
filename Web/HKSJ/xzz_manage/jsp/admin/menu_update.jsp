...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/admin/menu_update.js"></script>
  </head>
  ...
  <body>
  	<form id="menuForm" method="post" >
  		...
  		<input type="hidden" id="LEAF_OLD" name="LEAF_OLD"/>
		...
		<tr><td >菜单类型：</td><td>
			<select id="LEAF" name="LEAF" onchange="selectMenu(this)" read>
