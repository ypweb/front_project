...
<script type="text/javascript" src="js/behind/category/typetwo.js"></script>
<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
</head>

<body>
	<div class="main_r">
		<h3 class="right_nav">运营管理 > 二级类型管理</h3>
		...
		<div class="table_bg">
			<ul class="inquire">
				<div class="clearfix">
					...
					<li>
							<button type="button" class="btn_cx" onclick="toAdd()">新增二级类型</button>
					</li>
				</div>
			</ul>
