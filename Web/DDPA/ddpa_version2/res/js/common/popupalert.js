...
function popup_confirm(infos){
		...
		if($.browser.msie){
			if($.browser.version<7){
				$.blockUI({css:{'width':'306px','height':'156px'},message:"<div class=\"confirm_wrapie\"><p>"+infos+"</p><a id=\"popup_sure\" title=\"\" class=\"confirm_sure\" href=\"\">确&nbsp;认</a><a class=\"confirm_cance\" id=\"popup_cance\" title=\"\" href=\"\">取&nbsp;消</a></div>"});
			}else{
				$.blockUI({css:{'width':'306px','height':'156px','-moz-box-shadow':'none','-ms-box-shadow':'none','-o-box-shadow':'none','-webkit-box-shadow':'none','box-shadow':'none','background-color':'transparent'},message:"<div class=\"confirm_wrap\"><p>"+infos+"</p><a id=\"popup_sure\" class=\"confirm_sure\"  title=\"\" href=\"\">确&nbsp;认</a><a id=\"popup_cance\" class=\"confirm_cance\"  title=\"\" href=\"\">取&nbsp;消</a></div>"});
			}
		}else{
			$.blockUI({css:{'width':'306px','height':'156px','-moz-box-shadow':'none','-ms-box-shadow':'none','-o-box-shadow':'none','-webkit-box-shadow':'none','box-shadow':'none','background-color':'transparent'},message:"<div class=\"confirm_wrap\"><p>"+infos+"</p><a id=\"popup_sure\" class=\"confirm_sure\" title=\"\" href=\"\">确&nbsp;认</a><a id=\"popup_cance\" title=\"\" class=\"confirm_cance\" href=\"\">取&nbsp;消</a></div>"});
		}
		/*绑定确认,取消事件*/
