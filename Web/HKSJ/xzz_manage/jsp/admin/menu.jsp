...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/admin/menu.js"></script>
   ...
   <body>
		<div class="main_r">
			<h3 class="right_nav">系统管理 > 菜单信息</h3>
				...
				<ul class="inquire">
					<div class="clearfix">
						...
						<label class="v">名称：</label>
							<input id="menuName" name="menuName" type="text" class="input v">
						<label class="v">描述：</label>
							<input id="descc" name="descc" type="text" class="input v">
						</li>
						<li>
