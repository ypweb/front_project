(function($){
	$(function(){
		...
		var tempiurl=init_imgurl.slice(0,-4)+"_bg.jpg";
		slide_wrapbg.css({"background":"#fff url("+tempiurl+") repeat 0 0","opacity":"0.2"}).animate({"opacity":"0.8"},500);
		/*slide 播放*/
		function slide_play(){
			var n=0;
			...
			var tempiurl=tempimg_url.slice(0,-4)+"_bg.jpg";
			slide_wrapbg.css({"background":"#fff url("+tempiurl+") repeat 0 0","opacity":"0.2"}).animate({"opacity":"0.8"},500);
		}
		/*选项按钮事件监听*/
