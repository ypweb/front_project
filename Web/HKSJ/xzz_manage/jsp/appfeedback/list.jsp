...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/appfeedback/appfeedback.js"></script>
   ...
   <body>
		<div class="main_r">
			<h3 class="right_nav">反馈管理> 意见反馈信息</h3>

			<div class="table_bg">
				<ul class="inquire">
					<div class="clearfix">
						<li>
						<label class="v">意见反馈内容：</label>
							<input id="feedback" name="feedback" type="text" class="input v" style="width: 200px">&nbsp;&nbsp;&nbsp;
