...
<script type="text/javascript" src="js/behind/category/typeone.js"></script>
...
<body>
	...
	<div class="main_r">
		<h3 class="right_nav">运营管理 > 一级类型管理</h3>

		<div class="table_bg">
			<ul class="inquire">
				<div class="clearfix">
					<li>
						<button class="btn_cx" type="button" onclick="toAdd()">新增一级类型</button>
					</li>
				</div>
			</ul>
