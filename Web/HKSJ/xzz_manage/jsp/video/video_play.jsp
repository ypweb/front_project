...
<html> 
    <head>
       ...
       <meta http-equiv="pragma" content="no-cache">
        ...
        <script type="text/javascript" src="js/playVideo/swfobject.js"></script>
		<script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
		<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
		<script type="text/javascript" src="js/js_common.js"></script>
		<script type="text/javascript" src="js/behind/video/video_play.js"></script>
        <script type="text/javascript">
            ...
            swfobject.embedSWF(
                "js/playVideo/flash/Test.swf", "flashContent", 
                "1066", "600", 
    ...
    <body  align="center">
        ...
        <div  align="center">
	        ...
	        <form id="insertorupdateForm" method="post" style="width:500;height:300;text-align: center">
