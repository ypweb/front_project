$(function(){
	var slide_id=setInterval(slide_play,6000),slide_hover_id,slide_img=$("#slide_img li"),slide_tag=$("#slide_tag li"),slide_wrap=$("#slide_wrap"),index_arr=[],slide_count=(function(){var j=0;return function(){return ++j;};}()),slide_tips=$("#slide_tips"),auto_animates;
	...
	function slide_play(){
		...
		slide_img.eq(n).addClass("slideimg_sel").siblings().removeClass("slideimg_sel");
	...
	slide_tag.click(function(e){
		...
		slide_img.eq(cur_index).addClass("slideimg_sel").siblings().removeClass("slideimg_sel");
