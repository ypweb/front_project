...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/followRecord/auditList.js"></script>
		...
		<div class="main_r">
			...
			<div class="table_bg">
				<ul class="inquire">
					<div class="clearfix"> 
						<li>
							<button id="getTaskBut" type="button" class="btn_cx" disabled="disabled"   onclick="getTask()">获取10个任务</button> 
						</li>  
					</div>
