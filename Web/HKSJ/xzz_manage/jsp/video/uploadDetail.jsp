...
<html>
  <head>
   <base href="<%=basePath%>">
	...
	<script type="text/javascript" src="js/behind/video/uploadDetail.js"></script>
  ...
  <body>
  	...
  	<input type="hidden" id="MAX_UPLOAD_DAY" value="${MAX_UPLOAD_DAY}"/>
  	<input type="hidden" id="FIRST_UPLOAD_CONFIG" value="${FIRST_UPLOAD_CONFIG}"/>
  	<input type="hidden" id="CHECK_VIDEO_MAX" value="100000"/>
  	<input type="hidden" id="CHECK_VIDEO_MIN" value="10"/>
  	<input type="hidden" id="videoUrl" value="${videoUrl}"/>
  	<input type="hidden" id="imageUrl" value="${imageUrl}"/>
  	<input type="hidden" id="userRoleId" value="${adminInfo.roleId}"/>
  	 <input type="hidden" id="VIDEO_SON_ID" name="VIDEO_SON_ID" />
		<div class="main_r">
			<h3 class="right_nav">视频管理 > 视频审核</h3>
			...
			<div class="table_bg">
				<ul class="inquire">
					...
					<li>
						<label class="v">上传者：</label>
						<input id="userName"  type="text" class="input v">
					</li>
				<li>
						<label class="v">上传者手机号码：</label>
						<input id="CELLPHONE" name="CELLPHONE"  type="text" class="input v">
				</li>
					<li>
						<label class="v">上传者昵称：</label>
						<input id="NICK"  name="NICK" type="text" class="input v">
				</li>
				...
				<ul class="inquire">
					...
					<li>
						...
						<select style="height: 30px;line-height: 30px;" class="status_btn" id="selectStatus" >
							...
							<option value="1">转码成功(待审批)</option>
