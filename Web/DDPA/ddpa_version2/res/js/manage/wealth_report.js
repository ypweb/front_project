...
(function($){
	$(function(){
		...
		/*查询初始化*/
		handleReqAll();
		if(wr_sumtype==0||wr_sumtype==0.00){
			wr_pienodata1=true;
		}else{
			wr_pienodata1=false;
		}
		...
		curChart = $('#wr_caidatachart').highcharts();
		//数据过滤
		...
		/*图标数据过滤*/
		chart1 = $('#wr_allidatachart').highcharts();
		...
		/*图标数据过滤*/
		chart2 = $('#wr_ccedatachart').highcharts();
		...
		$("#wr_caibtn,#wr_allibtn,#wr_ccbtn,#wr_ccebtn").click(function(e){
			...
			if(thisobj.nodeName=="LI"){
				...
				if(curid=="wr_cai"){
					...
					wr_caiobj.series[0].data=wr_cairesult2;
					wr_caiobj.series[1].data=wr_cairesult1;
		...
		function handleReqAll(){
			...
			$.ajax({
				...
				error:function(){
					...
					//测试代码
					for(var i=0;i<6;i++){
							wr_cairesult1.push(parseInt(Math.random()*100000));
							wr_cairesult2.push(parseInt(Math.random()*100000));
					}
				}
			});
			$.ajax({
				...
				error:function(){
					...
					//测试代码
					for(var i=0;i<6;i++){
							wr_alliresult1.push(parseInt(Math.random()*100000));
							wr_alliresult2.push(parseInt(Math.random()*100000));
					}
			...
			$.ajax({
				...
				error:function(){
					...
					//测试代码
					for(var i=0;i<6;i++){
							wr_ccresult1.push(parseInt(Math.random()*100000));
					}
			...
			$.ajax({
				...
				error:function(){
					...
					//测试代码
					for(var i=0;i<6;i++){
							wr_cceresult1.push(parseInt(Math.random()*100000));
							wr_cceresult2.push(parseInt(Math.random()*100000));
							wr_cceresult3.push(parseInt(Math.random()*100000));
							wr_cceresult4.push(parseInt(Math.random()*100000));
					}
