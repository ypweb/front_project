$(function(){
	var slide_id=setInterval(slide_play,6000),slide_hover_id,slide_imgwrap=$("#slide_img"),slide_img=slide_imgwrap.find("li"),slide_tag=$("#slide_tag li"),slide_wrap=$("#slide_wrap"),index_arr=[],slide_count=(function(){var j=0;return function(){return ++j;};}()),slide_tips=$("#slide_tips"),auto_animates;
	var slideimg_index=slide_img.index(),initimg_alt=slide_img.eq(0).find("img").attr("alt"),initimg_temp="";
	/*img init*/
	slide_imgwrap.css({"width":slide_img.size()*960});
	/*text init*/
	...
	function slide_play(){
		...
		slide_imgwrap.animate({"left":-n*960},500);
	...
	slide_tag.click(function(e){
		...
		slide_imgwrap.animate({"left":-cur_index*960},500);
