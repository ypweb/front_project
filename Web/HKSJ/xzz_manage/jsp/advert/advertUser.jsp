...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/advert/advertUser.js"></script>
	<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
  </head>
  
  <body>
		<div class="main_r">
			<h3 class="right_nav">广告管理 > 广告商用户管理</h3>
				...
				<ul class="inquire">
					<div class="clearfix">
						<li>
							...
							<input id="ADVERT_COMPANY" type="text" class="input v">
						</li>
						<li>
