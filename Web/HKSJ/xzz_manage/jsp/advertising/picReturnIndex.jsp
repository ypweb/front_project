...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/advertising/picReturn.js"></script>
   ...
   <body>
		<div class="main_r">
			<h3 class="right_nav">广告管理>首页图片广告</h3>

			<div class="table_bg">
				<ul class="inquire">
					<div class="clearfix">
						<li>
						<label class="v">类别：</label>
						<select id="type" name="type" class="input v">
