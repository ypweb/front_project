...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/advertising/advertFollowPic.js"></script>
   ...
   <body>
		<div class="main_r">
			<h3 class="right_nav">广告管理> 随记图片广告</h3>

			<div class="table_bg">
				<ul class="inquire">
					<div class="clearfix">
						<li>
						<label class="v">广告内容：</label>
						<input id="content" name="content" type="text" class="input v">
						</li>
						<li>
