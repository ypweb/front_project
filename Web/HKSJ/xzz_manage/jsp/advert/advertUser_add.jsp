...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/advert/advertUser_add.js"></script>
  </head>
  
  <body>
  	<input type="hidden" id="contextPath" value="<%=path %>" /> 
  	<form id="addAdvertUserForm" method="post" >
		...
		<input type="password" id="ADVERT_PASSWORD"  name="ADVERT_PASSWORD" maxlength="10">  
