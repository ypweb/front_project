...
function add()
{
//	if($("#PIC_URL").val().replace(/[ ]/g,"")=="")
//	{
//		$.messager.alert("提示","图片不能为空","info",function(){document.getElementById("PIC_URL").focus();});
//		return;
//	}
	...
	$.post('saveAdvertPlatform.do',$("#insertorupdForm").serialize(),function(result){
		if(result==1) //修改成功
		{
