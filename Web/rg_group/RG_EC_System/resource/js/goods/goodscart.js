				...
				if(values!=''){
						...
						$.ajax({
								...
								success: function(data){
										if(data){
												//填充查询结果集
												var tempres='<tr><td><span data-value="'+data['数据序列号']+'" data-action="delete">删除</span></td><td><em>'+data['分公司']+'</em>/<em>'+data['仓库编号']+'</em></td><td><p>'+data['商品代码']+'</p></td><td>'+data['商品名称']+'</td><td><p>'+data['FV']+'</p></td><td><p>'+data['F$']+'</p></td><td>'+data['可用库存量']+'</td><td><input type="text" name="buys" value="'+data['购买数量']+'" class="g-wpx1 shopping-buys-number"></td>';
						...
						//下面是测试代码，开发阶段请删除此段代码
						var tempresf='<tr><td><span data-value="1" data-action="delete">删除</span></td><td><em>深圳龙华店</em>/<em>SDF3465472</em></td><td><p>356fgshr</p></td><td>深圳公司</td><td><p>ET23456</p></td><td><p>562556</p></td><td>'+parseInt(Math.random()*100)+'</td><td><input type="text" name="buys" value="1" class="g-wpx1 shopping-buys-number"></td></tr>';
