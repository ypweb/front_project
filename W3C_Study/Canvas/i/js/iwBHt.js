...
Shape.text = function() {
	...
	this.fillText = "headwinds was here";
...
var Player = function(x, y, r, colour) {
	this.shapes = {};
	...
	this.draw = function(camera) {
		...
		this.shapes.circle.strokeStyle = colour;
...
var player = new Player(levelStart.x + 75, levelStart.y, 20, "#FF0000");
player.level = 1;

var player2 = new Player(levelStart.x - 75, levelStart.y, 20, "#FFFFFF");
player2.level = 2;
...
var update = function() {
	...
	camera.update(lines, player2);
	player.update(player.level === 2 ? lines2 : lines);
  player2.update(player2.level === 2 ? lines2 : lines);
