...
<script type="text/javascript" src="js/behind/advert/theatre_update.js"></script>
</head>
</body>
		...
		<div style="margin-left:10px; height: 50px">
			<table class="mainTable">
				...
				<tr>
					<td>推荐位置：</td>
					<td colspan="2">
						<select  id="TYPE" name="TYPE"  onchange="changeIndex(this.value)">
						</select>
				...
				<tr>
					<td>排列号：</td>
					<td colspan="2"><input maxlength="9" id="SORT" name="SORT"
						type="text" value=""
