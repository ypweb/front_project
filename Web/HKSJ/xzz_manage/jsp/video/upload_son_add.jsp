...
<head>
	...
	<script type="text/javascript" src="js/behind/video/upload_son_add.js"></script>
</head>
<body>
	<form id="insertorupdateForm" method="post" >
		 ...
		 <input type="hidden" id="PIC_URL1" name="PIC_URL1"/> <!-- 海报切图 -->
         <div style="margin-left:10px;">
         	<span style="color: red">视频支持格式：asx,asf,mpg,wmv,3gp,mp4,mov,avi,flv,mkv</span>
  			<table class="mainTable">
				...
				<td>看点：</td>
		  		<td  colspan="2">
					<input id="SERIES_NAME" name="SERIES_NAME" maxlength="15"> 
				...
				<td>介绍：</td>
		  		<td  colspan="2">
					<textarea id="SERIES_CONTENT" name="SERIES_CONTENT" ></textarea>
