...
<html>
  <head>
	...
	<script type="text/javascript" src="js/behind/admin/role.js"></script>
	<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
  </head>
   <body>
		<div class="main_r">
			<h3 class="right_nav">系统管理 > 角色信息</h3>
				...
				<ul class="inquire">
					<div class="clearfix">
						...
						<label class="v">名称：</label>
							<input id="rolename" name="rolename" type="text" class="input v">
						<label class="v">备注：</label>
							<input id="roledescc" name="roledescc" type="text" class="input v">
						</li>
						<li>
