...
function resizable(breakpoint) {
	...
	if(is('tabletscreen'))
	{
		public_vars.$main_menu_wrap.addClass('collapsed');
		public_tool.scrollDestroy(public_vars.$main_menu_wrap);
	}
	...
	$(document).ready(function() {
		...
		$('a[data-toggle="sidebar"]').each(function(i, el) {
			$(el).on('click', function(ev) {
				...
				{
					public_vars.$main_menu_wrap.removeClass('collapsed');
