...
function up(str){
		...
		str = str.replace(/\[img\]([^\[]*)\[\/img\]/ig,'<img src="../../res/js/common/$1" border="0" />');
		str = str.replace(/\[url=([^\]]+)\]([^\[]+)\[\/url\]/ig, '<a href="../../res/js/common/$1">'+'$2'+'</a>');
		str = str.replace(/\[url\]([^\[]+)\[\/url\]/ig, '<a href="../../res/js/common/$1">'+'$1'+'</a>');
		return str;
	}
