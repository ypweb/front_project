	...
	function H(a,b,d)
		{
			for(var e in a)
			{
				var f=b[a[e]];if(f!==c)return d===!1?a[e]:E(f,"function")?f.bind(d||b):f}return!1
			}
			function I(a,b,c)
			{
			...
			function J()
			{
				e.input=function(c)
				{
					...
					d<e;d++)t[c[d]]=c[d]in k;
					return t.list&&(t.list=!!b.createElement("")&&!!a.HTMLDataListElement),
					t
				}
				("".split("")),
				e.inputtypes=function(a)
				{
					...
					d<i;d++)k.setAttribute("type",f=a[d]),e=k.type!=="text",e&&(k.value=l,k.style.cssText="",
				...
				z=function()
				{
					function d(d,e){e=e||b.createElement(a[d]||"div"),
					d="on"+d;
					var f=d in e;
			...
			(),A={}.hasOwnProperty,B;!E(A,"undefined")&&!E(A.call,"undefined")?B=function(a,b)
			{
				return A.call(a,b)
			}
			:B=function(a,b)
			...
			r.fontface=function()
			{
				var a;return x('@font-face {font-family:"font";}',
				function(c,d)
				{
				...
				{
					var a;return x(['#modernizr:after{content:"',l,'";visibility:hidden}'].join(""),
					function(b)
					{a=b.offsetHeight>=1}),
					a
				},
				...
				r.applicationcache=function()
				{
					...
					for(var K in r)B(r,K)&&(w=K.toLowerCase(),
					e[w]=r[K](),
					u.push((e[w]?"":"no-")+w));
					return e.input||J(),
					...
					{
						if
						(typeof a=="object")for(var d in a)B(a,d)&&e.addTest(d,a[d]);
						else
						{
							a=a.toLowerCase();
							if
							(e[a]!==c)return e;
							b=typeof b=="function"?b():b,f&&(g.className+=" "+(b?"":"no-")+a),
							e[a]=b}return e},C(""),
							i=k=null,
							e._version=d,
							e._prefixes=n,
						...
						function(a,b)
						{
							...
							if
							(j)return a.createDocumentFragment();
							c=c||m(a);
						...
						function p(a,b)
						{
							...
							("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+l().join().replace(/\w+/g,
							function(a)
							{
						...
						function z(a)
						{
							...
							e=a.namespaces,
							f=a.parentWindow;
							return!u||a.printShived?a:(typeof e[t]=="undefined"&&e.add(t),
							...
							var r={elements:c.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
							shivCSS:c.shivCSS!==!1,
					...
					function(a,b,c)
					{
						...
						function j(a,b,c,d,f)
						{
							return q=0,b=b||"j",
							e(a)?i("c"==b?v:u,a,b,
							this.i++,c,d,f):(p.splice(this.i++,0,a),
							1==p.length&&h()),
							this		
						}
						function k()
						{
							var a=B;return a.loader={load:j,
							i:0
						},
						a
					}
								...
								B.addFilter=function(a)
								{
									...
									A=function()
									{
										...
										a.yepnope.injectCss=function(a,c,d,e,g,i)
										{
											...
											j,c=i?h:c||f;e.href=a,e.rel="stylesheet",
											e.type="text/css";
